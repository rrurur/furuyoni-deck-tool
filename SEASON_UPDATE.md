...
1. 旧カードを置く
2. 旧シーズンの例外カードで置き換える
3. 再演にいるキャラクターだけ、再演の通常形カードで置き換える
4. 再演のA1・A2など、その形態専用カードで置き換える

再演にいないキャラクターは1と2の状態を維持します。再演の通常形カードを
旧シーズンのA1・A2カードで再び上書きしてはいけません。

例: オボロA1の通常札3・4は、再演では次の結果になります。

- 3番: `na_05_oboro_o_n_3.png`
- 4番: `na_05_oboro_a1_n_4.png`
